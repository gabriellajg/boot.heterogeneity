...
Inclusion of *moderators* is an option for researchers who are interested in measuring the size of the between-study heterogeneity and using factors to  explain the systematic between-study heterogeneity. To see how we include moderators, please go to section 1.2. 
