...
Install the released version of boot.heterogeneity from [CRAN](https://cran.r-project.org/web/packages/mc.heterogeneity/index.html) with:
...
* In the second line, the Q-statistic is still 34.87 but the bootstrap-based p-value is 0.06. This means that the assumption of homogeneity marginally significant but not rejected at an alpha level of 0.05. 

* In the third line, the REML-LRT statistic is 3.07 and the bootstrap-based p-value is 0.022. This means that the assumption of homogeneity is rejected and the true effect sizes are heterogeneous at an alpha level of 0.05.
